...
namespace puma560
{
    ...
    class Program
    {
        ...
        public double tau4(double tau1, double r13, double r23, double r33, double c23, double s23)
        {
            double c1 = Math.Cos(tau1);
            double s1 = Math.Sin(tau1);
        ...
        public double tau5(double tau1, double tau4, double r13, double c23, double s23, double r23, double r33)
        {
            double c1 = Math.Cos(tau1);
        ...
        public double tau6(double tau1, double tau4,double tau5, double c23,double s23, double r11, double r21, double r31 )
        {
            double c1 = Math.Cos(tau1);
            double c4 = Math.Cos(tau4);
            double c5 = Math.Cos(tau5);
            double s1 = Math.Sin(tau1);
            double s4 = Math.Sin(tau4);
            double s5 = Math.Sin(tau5);
